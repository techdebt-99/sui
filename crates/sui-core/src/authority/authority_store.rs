...
impl AuthorityStore {
    ...
    pub(crate) fn get_executed_effects(
        &self,
    ...
    pub(crate) fn is_shared_object_deleted(
        &self,
        object_id: &ObjectID,
        epoch_id: EpochId,
    ) -> SuiResult<bool> {
    ...
    pub(crate) fn get_input_object_locks(
        &self,
    ...
    #[cfg(msim)]
    pub(crate) fn remove_all_versions_of_object(&self, object_id: ObjectID) {
